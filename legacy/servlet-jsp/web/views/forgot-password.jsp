    ...
    <div class="container">
        <div class="forgot-card animate__animated animate__zoomIn">
            <div class="forgot-icon">
                <i class="fas fa-lock forgot-fa-icon" aria-hidden="true"></i>
            </div>
            ...
            <c:if test="${not empty successMsg}">
                <div class="alert alert-success small mb-4" role="alert">
                    <i class="fas fa-circle-check iconly-anim alert-icon-success me-2" aria-hidden="true"></i>${successMsg}
                </div>
            </c:if>
            
            <c:if test="${not empty errorMsg}">
                <div class="alert alert-danger small mb-4" role="alert">
                    <i class="fas fa-circle-exclamation iconly-anim alert-icon-error me-2" aria-hidden="true"></i>${errorMsg}
                </div>
            </c:if>
            ...
            <a href="${pageContext.request.contextPath}/login" class="back-to-login">
                <i class="fas fa-arrow-left iconly-anim back-icon me-2" aria-hidden="true"></i>Quay lại Đăng nhập
            </a>
        </div>
    </div>
</section>
