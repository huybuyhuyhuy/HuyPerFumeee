                ...
                <form action="${pageContext.request.contextPath}/admin/product/edit" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="batch_code" class="form-control" value="${product.batch_code}">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="scent_notes" class="form-control" rows="2">${product.scent_notes}</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="form-check mb-4">
                        <input type="checkbox" name="is_decant" class="form-check-input" id="isDecant" ${product.is_decant ? 'checked' : ''}>
                        <label class="form-check-label" for="isDecant">Sản phẩm hàng chiết</label>
                    </div>
