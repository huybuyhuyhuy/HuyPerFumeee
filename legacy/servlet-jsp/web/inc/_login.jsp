                    ...
                    <form method="post" action="${pageContext.request.contextPath}/login">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">
                                <i class="fas fa-envelope form-label-icon me-2"></i>Email hoặc Số điện thoại
                            </label>
                            <input type="text" 
                                   name="emailphone" 
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">
                                <i class="fas fa-lock form-label-icon me-2"></i>Mật khẩu
                            </label>
                            <input type="password" 
                                   name="password" 
                                   class="form-control form-control-custom" 
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-gold btn-lg">
                                <i class="fas fa-right-to-bracket btn-label-icon me-2"></i>ĐĂNG NHẬP
                            </button>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="${pageContext.request.contextPath}/forgot-password" class="text-decoration-none" style="color: var(--gold);">
                                <i class="fas fa-key link-label-icon me-1"></i>Quên mật khẩu?
                            </a>
                        </div>
                    </form>
                </div>
