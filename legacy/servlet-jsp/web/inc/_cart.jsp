                                ...
                                <div class="card-body p-4">
                                    <div class="row d-flex justify-content-between align-items-center">
                                        <div class="col-md-2 col-lg-2 col-xl-2">
                                            <c:choose>
                                                <c:when test="${not empty p.image && (p.image.startsWith('http') || p.image.endsWith('.jpg') || p.image.endsWith('.jpeg') || p.image.endsWith('.png') || p.image.endsWith('.webp') || p.image.endsWith('.gif'))}">
                                                    <img src="${p.image.startsWith('http') ? p.image : pageContext.request.contextPath.concat('/api/image?name=').concat(p.image)}" class="img-fluid rounded-3 shadow-sm" alt="${p.name}">
                                                </c:when>
                                                <c:otherwise>
                                        ...
                                        <div class="col-md-3 col-lg-3 col-xl-4">
                                            <p class="lead fw-bold mb-2"><a href="product-detail?id=${p.id}" class="text-dark text-decoration-none">${p.name}</a></p>
                                            <c:choose>
                        ...
                        <div id="payment-section" style="display: none;" class="card shadow-sm border-0 mb-5 border-top border-warning border-4">
                            <div class="card-body p-4">
                                ...
                                <div class="row g-3 mb-4 justify-content-center">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <label class="payment-option-card border rounded p-3 d-block text-center cursor-pointer" for="zalopay">
                                            <input class="form-check-input mb-2" type="radio" name="paymentSelector" id="zalopay" value="ZaloPay">
                                            <i class="fas fa-wallet fa-2x d-block mb-2 text-success"></i>
                                            <span class="fw-bold d-block">Ví ZaloPay</span>
                                        </label>
                                    </div>
                                    <div class="col-md-3 col-sm-6">
                                ...
                                <div id="form-Momo" class="payment-form-container border rounded p-4 mb-3 text-center" style="display: none; background: #fff;">
                                    ...
                                    <p class="text-muted small mb-3">
                                        Bấm nút bên dưới: hệ thống tạo đơn hàng, sau đó <strong>chuyển sang trang thanh toán MoMo</strong>.
                                    </p>
                                    <form action="checkout" method="POST" class="momo-checkout-form">
                                        ...
                                        <div class="alert alert-light border small text-start mx-auto" style="max-width: 520px;">
                                            ...
                                            (số tiền tối thiểu 10.000đ nếu đơn nhỏ hơn).
                                        </div>
                                ...
                                <!-- FORM ZALOPAY -->
                                <div id="form-ZaloPay" class="payment-form-container border rounded p-4 mb-3 text-center" style="display: none; background: #fff;">
                                    <h5 class="fw-bold mb-2 text-success"><i class="fas fa-wallet me-2"></i>Thanh toán qua ZaloPay</h5>
                                    <p class="text-muted small mb-3">
                                        Bấm xác nhận để chuyển sang cổng thanh toán ZaloPay.
                                    </p>
                                    <form action="checkout" method="POST">
                                        <input type="hidden" name="paymentMethod" value="ZaloPay">
                                        <div class="alert alert-light border small text-start mx-auto" style="max-width: 520px;">
                                            Số tiền: <strong><fmt:formatNumber value="${total}" pattern="#,##0"/>đ</strong>
                                        </div>
                                        <div class="text-center mt-3">
                                            <button type="submit" class="btn btn-success btn-lg px-5 fw-bold shadow">
                                                XÁC NHẬN VÀ THANH TOÁN ZALOPAY
                                            </button>
                                        </div>
                                    </form>
                                </div>
