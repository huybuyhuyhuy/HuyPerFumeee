...
app.post('/payment', async (req, res) => {
  ...
  if (!accessKey || !secretKey) {
    return res.status(500).json({ message: 'Missing MOMO_ACCESS_KEY or MOMO_SECRET_KEY' });
  }
  ...
  const options = {
    method: 'POST',
    url: process.env.MOMO_CREATE_ENDPOINT || 'https://test-payment.momo.vn/v2/gateway/api/create',
    headers: {
