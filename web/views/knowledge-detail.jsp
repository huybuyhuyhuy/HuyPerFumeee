...
<div class="detail-wrap">
    <div class="container">
        <a href="${pageContext.request.contextPath}/knowledge" class="btn btn-outline-secondary btn-sm mb-3">← Quay lại Kiến thức</a>
...
<script>
    (async function () {
        ...
        var res = await fetch('${pageContext.request.contextPath}/api/content?type=knowledge&id=' + encodeURIComponent(id));
        ...
        document.getElementById('related-content').innerHTML = related.map(function (r) {
            var target = r.id && r.id.indexOf('bl-') === 0 ? 'blog-detail' : 'knowledge-detail';
