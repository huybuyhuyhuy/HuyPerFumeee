...
function getStatusTitle(status: string) {
  ...
  if (status === 'pending') return 'Đang chờ MoMo xác nhận';
...
function getStatusMessage(status: string, payment: string, resultCode?: string | null) {
  ...
  if (status === 'pending') return `MoMo đã chuyển bạn về website, nhưng hệ thống vẫn đang chờ xác nhận thanh toán chính thức. Đơn hàng chưa được đánh dấu đã thanh toán.`;
